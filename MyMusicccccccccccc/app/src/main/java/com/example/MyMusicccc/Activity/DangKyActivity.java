...
import com.example.MyMusicccc.Fragment.Dialog_Dangky_Free;
...
public class DangKyActivity extends AppCompatActivity implements Dialog_Dangky_Free.ExampleDialogListener {
    ...
    ImageView imgUser;
    LoginButton lgbtn;
    Button btndkfree, btndnfree, btndnkhach;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btndnkhach.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DangKyActivity.this, DangNhapActivity.class);
                startActivity(intent);
    ...
    private void AnhXa() {
        ...
        btndnkhach = findViewById(R.id.btnkhach);
    ...
    public void apply(String taikhoan, String matkhau, String emailz){
        ...
        name = taikhoan;
        email = emailz;
        imageurl = "https://docs.google.com/uc?id=1TnA9onLRCw06flZ1cbQTXpL60GmlCwYk";
